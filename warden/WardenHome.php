...
<?php 
		...
		$data=$_SESSION["username"];
			...
			{
				//echo "<script>alert('22222222222222');</script>";
    ...
    <body class="main_body">
        ...
        <div class="container links_in_div">
            <div class="row">
                <div class="col-sm-4 col-xs-12 home_page_link">
                ...
                <div class="col-sm-4 col-xs-12 home_page_link">
                    <div class="link_block">
                        <div class="home_page_link_icon"><span class="glyphicon glyphicon-edit"></span></div>
                        <div class="home_page_link_text"><a href="ViewComplain.php" class="btn btn-default">VIEW COMPLAIN</a></div>
                    </div>
                </div>
                
                <div class="col-sm-4 col-xs-12 home_page_link">
                    <div class="link_block">
                        <div class="home_page_link_icon"><span class="glyphicon glyphicon-plus"></span></div>
                        <div class="home_page_link_text"><a href="StudentRegistration.php" class="btn btn-default">ADD STUDENT</a></div>
                    </div>
                </div>
				<div class="col-sm-4 col-xs-12 home_page_link">
                    <div class="link_block">
                        <div class="home_page_link_icon"><span class="glyphicon glyphicon-plus"></span></div>
                        <div class="home_page_link_text"><a href="ParentsRegistration.php" class="btn btn-default">ADD PARENT</a></div>
                    </div>
                </div>
                
                <div class="col-sm-4 col-xs-12 home_page_link">
                    <div class="link_block">
                        <div class="home_page_link_icon"><span class="glyphicon glyphicon-search"></span></div>
                        <div class="home_page_link_text"><a href="searchStudent.php" class="btn btn-default">SEARCH STUDENT</a></div>
                    </div>
                </div>
                <div class="col-sm-4 col-xs-12 home_page_link">
                    <div class="link_block">
                        <div class="home_page_link_icon"><span class="fa fa-sign-out"></span></div>
                        <div class="home_page_link_text"><a href="room_detail.php" class="btn btn-default">ROOM DETAILS</a></div>
                    </div>
                </div>
            </div>
        </div>
