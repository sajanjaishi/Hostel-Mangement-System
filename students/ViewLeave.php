...
session_start();
    ...
    <body style="background-color:#c1c1c1;">
        ...
        <div class="container apply_leave_block">
            <div>
                <h2 class="heading_underline_effect_a heading_underline_effect1 text-center" style="color:#c1c1c1;">View Leave module</h2>
                <hr/>
                    ...
                    <div id="applyComplain" class="tab-pane fade in active">
                        <div class="">
							...
							<?php
								...
								$query="select * from leave_module where username='$uname'";
								echo "<table class='table wow flipInX' data-wow-delay='0.6s'>";
								echo "<tr style='background-color:#ff1616; color:white'><th>Index</th><th>From date</th><th>To date</th><th>Applied Date</th><th>Reason</th><th>Parent Status</th><th>Warden status</th><th>Reject reason</th></tr>";
								$i=0;
							if($result= $con->query($query))
							{
								...
								{
									$i++;
									echo "<tr style='color:white'><td>".$i."</td><td>".$row["FromDateTime"]."</td><td>".$row["ToDateTime"]."</td><td>".$row["AppliedDate"]."</td><td>".$row["Reason"]."</td><td>".$row["P_Status"]."</td><td>".$row["W_Status"]."</td><td>".$row["rejectReason"]."</td></tr>";
