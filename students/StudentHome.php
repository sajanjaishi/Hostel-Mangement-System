            ...
            <div class="row">
                <div class="col-md-4 col-sm-6 col-xs-12 home_page_link">
                    <div class="link_block">
                        ...
                        <div class="home_page_link_text"><a href="profile.php" class="btn btn-default">MY ACCOUNT</a></div>
                    </div>
                </div>
                <div class="col-md-4 col-sm-6 col-xs-12 home_page_link">
                    <div class="link_block">
                        <div class="home_page_link_icon"><span class="glyphicon glyphicon-calendar"></span></div>
                        <div class="home_page_link_text"><a href="ApplyLeave.php" class="btn btn-default">APPLY LEAVE</a></div>
                    </div>
                </div>
                <div class="col-md-4 col-sm-6 col-xs-12 home_page_link">
                    <div class="link_block">
                        <div class="home_page_link_icon"><span class="glyphicon glyphicon-edit"></span></div>
                        <div class="home_page_link_text"><a href="ApplyComplain.php" class="btn btn-default">APPLY COMPLAIN</a></div>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-md-4 col-sm-6 col-xs-12 home_page_link">
                    <div class="link_block">
                        <div class="home_page_link_icon"><span class="glyphicon glyphicon-bed"></span></div>
                        <div class="home_page_link_text"><a href="RoomSelection.php" class="btn btn-default">ROOM SELECTION</a></div>
                    </div>
                </div>
                <div class="col-md-4 col-sm-6 col-xs-12 home_page_link">
                    <div class="link_block">
                        <div class="home_page_link_icon"><span class="glyphicon glyphicon-bed"></span></div>
                        <div class="home_page_link_text"><a href="ChangeRoom.php" class="btn btn-default">CHANGE ROOM</a></div>
                    </div>
                </div>
                <div class="col-md-4 col-sm-6 col-xs-12 home_page_link">
                    <div class="link_block">
                        <div class="home_page_link_icon"><span class="glyphicon glyphicon-log-out"></span></div>
