                                    ...
                                    <form method="post"  class="wow flipInX" data-wow-delay="0.6s" autocomplete="off" onsubmit="return ValidationEvent()">
										...
										if(isset($_POST['btnchange']))
										{
											...
											if(!empty($old) && !empty($newpassword) && !empty($repassword))
											{
												...
												$query="select * from `parents_registration_master` where Username='".$_SESSION['username']."' and Password='$old' ";
															...
															if($row = $result->fetch_assoc())
															{
																...
																if($newpassword!=$repassword)
																{
																	...
																	try
																	{
																			...
																			$query="update `parents_registration_master` set Password='$newpassword' where Username='".$_SESSION['username']."' and Password='$old'";
